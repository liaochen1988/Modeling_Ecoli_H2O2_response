function dx = Kinetic_model2(t,x,arcA_mutant,fnr_mutant,a,called_by_ode15s,GSSG,Gor,kd_nadph)
...
v_Gor = (267 * GSSG  + 6.55e5 * GSSG ^ 2) * NADPH_uc * Gor ...
        / (2.22e-5 * GSSG + 9.7e-5 * NADPH_uc + GSSG * NADPH_uc + 0.022 * GSSG ^ 2 + 3.9e3 * GSSG ^ 2 * NADPH_uc); % M/s
...
if called_by_ode15s,
    ...
    % NADPH conc.
    dx(37,1) = v_G6PDH + v_PGDH + v_ICDH + v_Mez - v_Gor * 1e6 / 564 - kd_nadph * NADPH;
