...
gene_names = {'hemH';'ahpC';'ahpF';'dsbG';'uof';...
              'fur';'dps';'grxA';'ybjC';'nfsA';...
              'rimK';'ybjN';'hcp';'hcr';'poxB';...
              'ychF';'sufA';'sufB';'sufC';'sufD';...
              'sufE';'sufS';'znuC';'znuB';'znuA';...
              'zinT';'flu';'mntH';'trxC';'gor';...
              'metR';'metE';'katG';'oxyR';'gntP';...
              'uxuA';'uxuB';'fhuF';'yjjZ'};
...
total_protein = [680,238,450]; % fg, 1g = 1e15 fg
