function dx = Kinetic_model(t,x,arcA_mutant,fnr_mutant,a,called_by_ode15s,integrated,c_metE)
...
if (integrated)
    ...
    v_Bio_AA = k_elong * MET / (Km_met + MET) * RIB * ATP / (Km_atp / uc_gDCW_L + ATP) * f_rib_act;
    % Ribosome synthesis
