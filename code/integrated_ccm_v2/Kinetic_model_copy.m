...
% KatG
v_Bio_katG = 5.50e-9 * frac_oxyr * 5;
% AhpCF
...
% MetE
v_MetE_oxi = 0.230 * MetE_SH * GSSG; % uM/s
v_MetE_red = 0.165 * MetE_SSG * GSH; % uM/s
...
if called_by_ode15s,
    ...
    dx(48,1) = v_H2O2_metab_prod + v_H2O2_trans - v_Deg_auto ...
               ...
               - n_oxyr * v_OxyR_oxi - v_PSH_oxi - v_Met_oxi - v_GSH_oxi;                                         % H2O2
    % OxyR
...
%                + v_MetE_oxi * 1e-6 - v_MetE_red * 1e-6 - v_MetE_red2 ...
...
%                + v_OxyR_oxi2 * 8 - v_OxyR_red2 * 8;                                                               % GSH                                  
%     dx(57,1) = v_GSH_oxi - v_GSH_red - v_GSH_red2 ...
%                - v_OxyR_oxi2 * 4 + v_OxyR_red2 * 4;                                                               % GSSG  
%     % Thioredoxin
