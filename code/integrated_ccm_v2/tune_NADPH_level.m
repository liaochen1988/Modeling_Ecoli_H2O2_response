...
katG_mutant = false;
katE_mutant = false;
[t,x] = ode15s(@Kinetic_model,[-10000.0*3600.0 0.0],IC,options,arcA_mutant,fnr_mutant,katE_mutant,katG_mutant,a,V_env,true);
res = Kinetic_model(t(end),x(end,:),arcA_mutant,fnr_mutant,katE_mutant,katG_mutant,a,V_env,false);
res(1) * 3600 % desired growth rate (0.54 per hour)
