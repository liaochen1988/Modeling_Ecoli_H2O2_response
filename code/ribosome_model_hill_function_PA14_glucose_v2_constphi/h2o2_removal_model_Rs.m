function [dxdt,r_d,r_g] = h2o2_removal_model_Rs(t,x,optimalSol,k_o,k_u,k_d,Km_o,Km_u,Km_d,Ki_u,f_o,f_u,n_u,e_g,k_diff,Vin,Vout,r_g0,r_mc,...
...
% phi models
phi = pchip(optimalSol.time,optimalSol.phi,t);
